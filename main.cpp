...
int main(void) {
	...
	if (success1 == OPENVPN_PLUGIN_FUNC_DEFERRED || success1 == OPENVPN_PLUGIN_FUNC_DEFERRED || success1 == OPENVPN_PLUGIN_FUNC_DEFERRED || success1
		...
		do {
			if (file1.is_open()) {
				...
				file1.open(get_env("auth_control_file", env1));

			if (file2.is_open()) {
				file2.read(&c2, 1);
			} else
				file2.open(get_env("auth_control_file", env2));
			if (file3.is_open()) {
				file3.read(&c3, 1);
			} else
				file3.open(get_env("auth_control_file", env3));
			if (file4.is_open()) {
				file4.read(&c4, 1);
			} else
				file4.open(get_env("auth_control_file", env4));
			sleep(1);
	...
	if (success1 == 0 && success2 == 0 && success3 == 0 && success4 == 0 && success5 == 0 && success6 == 0 && success7 == 0 && success8 == 0 && success9 == 0
			&& success10 == 0 && success11 == 0 && success12 == 0) {
